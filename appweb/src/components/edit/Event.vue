    ...
    <div class="form">
        ...
        <div class="dates">
            <div class="date">
                ...
                <vue-ctk-date-time-picker v-model="start_date" label="" locale="fr" :minute-interval="60" :max-date="end_date"></vue-ctk-date-time-picker>
            </div>
            <div class="date">
...
<script>
    export default {
        ...
        methods: {
            submit () {
                this.$axios.put(this.$host+'/event/'+this.id, {
                        "name": this.name,
